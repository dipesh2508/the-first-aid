...
const HeroHospital = ({name, phone, email, city}: {name: string, phone: string, email: string, city: string}) => {
  return (
      ...
      <div className="absolute inset-0 z-10">
        <div className="container mx-auto px-10 py-8 flex flex-col h-full">
          <div className="text-center mb-10">
            <h1 className="text-4xl font-bold text-red-800 mb-2">Welcome to {name}</h1>
          ...
          <div className="flex justify-between items-center mb-8">
            {[ 
              ...
              { icon: FaMapMarkerAlt, title: 'Location', content: city },
            ].map((item, index) => (
