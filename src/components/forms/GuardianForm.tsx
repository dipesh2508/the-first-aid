...
export default function GuardianForm({
  ...
  return (
    <div className=" py-4 max-w-3xl flex items-center justify-center bg-white px-2 rounded-lg">
        ...
        <form onSubmit={handleSubmit} className=" space-y-6">
          <div className="border-b border-primary-9  ">
            ...
            <p className="text-sm text-gray-600 mb-2">
              Please enter the Username of the guardian who will be added to
          ...
          <div className="border-b border-primary-9  p-4 ">
            ...
            <p className="text-sm text-gray-600">
              I, {name}, confirm that the above information is accurate and
              true. I authorize the first aid team to add the listed guardian to
              my profile and contact them in case of an emergency or any
